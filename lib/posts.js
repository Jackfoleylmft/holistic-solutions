export const posts = [
...

  {
    ...
    metaDescription: 'When a loved one refuses addiction or mental health treatment, families often feel stuck. Learn what actually works — including CRAFT, motivational interviewing, and when to consider a clinical intervention.',
    date: '2026-03-02',
...

  {
    ...
    metaDescription: 'First episode psychosis is treatable, and early intervention dramatically improves long-term outcomes. A clinical guide for families on warning signs, coordinated specialty care, and what to do next.',
    date: '2026-03-02',
    category: 'Clinical Insights',
    image: null,
...

  {
    ...
    metaDescription: 'A clinical intervention is not a surprise ambush. Learn what evidence-based intervention models actually look like, why clinical oversight matters, and when intervention is — and isn\'t — the right step.',
    date: '2026-03-02',
    category: 'Clinical Insights',
    image: null,
    relatedServices: ['intervention-services', 'substance-use', 'mental-health'],
...

  {
    ...
    metaDescription: 'Co-occurring disorders — addiction alongside mental illness — require integrated treatment to address both conditions simultaneously. Learn why sequential treatment fails and what evidence-based integrated care looks like.',
    date: '2026-03-02',
    category: 'Clinical Insights',
    image: null,
...

  {
    ...
    metaDescription: 'Choosing the right addiction or mental health treatment program is complex. Learn what questions to ask, what red flags to watch for, and how clinical case management helps families find the right fit.',
    date: '2026-03-02',
    category: 'Family Guidance',
    image: null,
...

  {
    ...
    metaDescription: 'Clinical case management bridges the gap between a person and the care they need. Learn what a clinical case manager actually does, who benefits most, and how it differs from therapy or standard care coordination.',
    date: '2026-03-02',
    category: 'Clinical Insights',
    image: null,
...

  {
    ...
    metaDescription: 'A therapist and a clinical case manager serve different functions. Learn the key differences, when you need one versus the other, and when having both is what a complex situation actually requires.',
    date: '2026-03-02',
    category: 'Clinical Insights',
    image: null,
...

  {
    ...
    metaDescription: 'The transition from treatment back to daily life is the highest-risk period in recovery. Learn what evidence-based continuing care looks like, how to build a strong aftercare plan, and what families can do to help.',
    date: '2026-03-02',
    category: 'Family Guidance',
    image: null,
...

  {
    ...
    metaDescription: 'Helping a loved one with both a mental health condition and substance use disorder requires a different approach. Learn what dual diagnosis actually means, why integrated treatment matters, and how families can help most.',
    date: '2026-03-02',
    category: 'Family Guidance',
    image: null,
    relatedServices: ['co-occurring-disorders', 'mental-health', 'substance-use'],
...

  {
    ...
    metaDescription: 'Sober companions and recovery coaches provide different kinds of post-treatment support. Learn the key differences, when each is appropriate, and how both fit into a comprehensive recovery plan.',
    date: '2026-03-02',
    category: 'Clinical Insights',
    image: null,
