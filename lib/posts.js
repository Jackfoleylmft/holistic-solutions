export const posts = [
...

  {
    ...
    body: [
      ...
      { type: 'p', text: 'Less obvious is how certain protective behaviors — managing consequences, covering for a loved one, keeping the peace at all costs — can reduce the motivation to seek change. This isn\'t a judgment. It\'s a pattern that has a name and an evidence-based alternative.' },
...

  {
    ...
    author: 'Jack Foley, LMFT | Holistic Solutions',
    excerpt: 'The most common mistake in treating addiction is treating it alone. Nearly half of people with a substance use disorder also have a co-occurring mental health condition — and when one goes untreated, the other almost always follows.',
