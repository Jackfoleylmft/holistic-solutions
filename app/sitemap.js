...
export default function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${base}/substance-use-case-management-las-vegas`, changeFrequency: 'monthly', priority: 0.85, lastModified: '2026-04-15' },
    { url: `${base}/psychosis-case-management-las-vegas`, changeFrequency: 'monthly', priority: 0.85, lastModified: '2026-04-15' },
    { url: `${base}/dual-diagnosis-case-management-las-vegas`, changeFrequency: 'monthly', priority: 0.85, lastModified: '2026-04-15' },
