        ...
        <div className="service-page-layout">
          <div className="service-page-main">
            ...
            <div style={{ marginTop: '3rem' }}>
              ...
              <p className="service-page-body">
                We also carry deep clinical expertise in two areas where most providers are generalists: substance use disorders and psychosis. These conditions frequently co-occur, and the intersection is where navigation gets most complex. For families navigating <Link href="/blog/fentanyl-addiction-what-families-need-to-know">fentanyl addiction</Link>, the clinical stakes are even higher — and clinical licensure is not optional. For clients navigating both substance use and mental health conditions, see our <Link href="/co-occurring-disorders-case-management">co-occurring disorders case management</Link> page. For cases where psychosis is part of the picture, see <Link href="/psychosis-case-management">psychosis case management</Link>.
              </p>
              <p className="service-page-body">
